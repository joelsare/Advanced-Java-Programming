package simplecalculatorclient;

import beans.CalculatorBeanRemote;
...
public class SimpleCalculatorClient extends JFrame
    ...
    private CalculatorBeanRemote _calculator;
    ...
    private CalculatorBeanRemote getCalculator() {
        ...
        try {
            ...
            final String jndiName = "CalculatorBean/remote";
...
//        = (Calculator) ctx.lookup(Calculator.class.getName());
    ...
    public static void main(String[] args) {
        SimpleCalculatorClient calcClient = new SimpleCalculatorClient();
    }
}
